...
home_layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.H1("Better Call Guga", className="popup-title"),
            html.P("⚖️ Your Legal Expert in Georgia ⚖️", className="popup-subtitle"),
            html.P("📞 +995 595 41 77 75", style={'color': 'white', 'fontSize': '1.2rem', 'marginBottom': '20px'}),
            html.Button("Close", id="popup-close", className="popup-close")
        ], className="popup-content")
    ], id="popup-overlay", className="popup-overlay"),
